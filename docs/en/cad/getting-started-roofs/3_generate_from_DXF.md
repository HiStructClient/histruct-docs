...
🚀 **Let's get started!**
 ...
 When creating a new project, select the option **Generate from outline.** ![pokus 1](img/Outlinetepmpl.png) Alternatively, you can directly open the **Templates** in upper left side of the HiStruct menu and choose this option as well. You'll enter the application directly and jump right to **Geometry** menu.
